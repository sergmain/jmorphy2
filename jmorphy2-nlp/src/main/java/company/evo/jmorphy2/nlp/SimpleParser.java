...
public class SimpleParser extends Parser {
    ...
    public SimpleParser(MorphAnalyzer morph, Tagger tagger, Ruleset rules, int threshold) {
        ...
        Set<String> allowed = new HashSet<>(getGrammemeValuesFor(Tag.CASE));
        allowed.addAll(getGrammemeValuesFor(Tag.NUMBER));
        this.allowedGrammemeValues = allowed;
    }
    ...
    private List<Node> reduce(Rule rule, List<Node> nodes, int offset) {
        List<Node> newNodesBuilder = new ArrayList<>();
        ...
        List<Node>  reducedNodesBuilder = new ArrayList<>();
        int i = 0;
        ...
        List<Node> reducedNodes = List.copyOf(reducedNodesBuilder);
        ...
        return List.copyOf(newNodesBuilder);
    }
